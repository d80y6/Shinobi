module.exports = function(s,config,lang,app,io){
    ...
    setDefaultIfUndefined(config, 'showPoweredByDAM VMS', true);
    setDefaultIfUndefined(config, 'poweredByDAM VMS', 'Powered by DAM VMS.Systems');
    ...
    setDefaultIfUndefined(config, 'logoLocation76x76Link', 'https://dam-vms.video');
    ...
    setDefaultIfUndefined(config, 'socialLinks', [
        { icon: 'home', href: 'https://dam-vms.video', title: 'Homepage' },
        { icon: 'facebook', href: 'https://www.facebook.com/DAM VMSCCTV', title: 'Facebook' },
        { icon: 'twitter', href: 'https://twitter.com/DAM VMSCCTV', title: 'Twitter' },
